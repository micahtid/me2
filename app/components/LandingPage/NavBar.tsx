  ...
  return (
    <nav className="w-full">
      ...
      >
        {/* Logo Section */}
        <div>
          <img src="favicon.ico" width={35} alt="Logo" />
        </div>
        ...
        <div className="flex flex-row justify-between items-center gap-x-6">
          ...
          <button
            ...
            className="flex justify-center items-center gap-x-2 px-5 py-3
              bg-header rounded-2xl font-medium text-white shadow-sm"
          >
            Log In
            <FaUser />
          </button>
      ...
      <div className="w-full flex justify-end p-4">
        <button
          ...
          className="p-3 hidden max-lg:inline bg-white rounded-2xl
