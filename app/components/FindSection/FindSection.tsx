...
const FindSection = () => {
    ...
    return (
        <div className="h-full flex flex-col justify-start items-start gap-y-3 max-lg:pb-6 overflow-y-auto no-scrollbar pb-5 px-8">
            <h3 className="text-2xl font-semibold mb-6">Find People</h3>
